    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                	<?= $form->field($model, 'comission_type_name')->textInput(['class'=>'form-control input-sm']) ?>
                    <?= $form->field($model, 'comission_type_desc')->textInput(['class'=>'form-control input-sm']) ?>
                    <?= $form->field($model, 'comission_type_value')->textInput(['class'=>'form-control angka input-sm']) ?>
                </div>
            </div>
        </div>
    </div>
