            ...
            <div class="card-content" style="background-color: #acadaf;">
                <div class="card-body padding-bottom-zero padding-top-zero" >
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <?= $form->field($model, 'invoice_number_document')->textInput(['class'=>'form-control input-sm']) ?>
                        </div>
                        <div class="col-lg-4 padding-top-one mbt-1">                           
                                <?= $form->field($model, 'invoice_type')->checkbox(['value' => 'ppn', 'class' => 'i-checks', 'checked' => true]) ?>
                                <i><p> *check for invoice type PPN</p></i>
                        </div>
                    </div>
                </div>
            </div>
