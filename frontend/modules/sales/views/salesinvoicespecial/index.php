                            ...
                            <?= GridView::widget([
						        ...
						        'columns' => [
                                    ...
                                    [
                                        ...
                                        'value' => function($model) {
                                            return $model->getInvoiceType($model->invoice_product_type) ? $model->invoice_product_type : "" ;
...
$(document).on("click", ".btn-print-delivery", function(e){
    ...
    var id = $(this).attr("id").split("-")[2];
    // alert(base3);
    $.post(base3+'/sales/salesinvoicespecial/print', {'invoiceId': id}, function(response) {
