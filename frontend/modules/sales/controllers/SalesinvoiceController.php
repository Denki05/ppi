...
class SalesinvoiceController extends BaseController
{
    ...
    {
        BaseController::$page_caption = 'Nota Khusus';
    ...
    {
        BaseController::$page_caption = 'Lihat Nota Khusus';
    ...
    {
        BaseController::$page_caption = 'Tambah Nota Khusus';
    ...
    {
		BaseController::$page_caption = 'Update Nota Khusus';
  ...
  //    */
    protected function findModel($id)
    {
        ...
        throw new NotFoundHttpException('Nota Khusus'.LabelComponent::NOT_FOUND);
    }
}
