...
CREATE TABLE IF NOT EXISTS `tbl_packaging` (
  ...
  `packaging_value` float NOT NULL,
  `packaging_packing` varchar(255) NOT NULL,
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_sales_invoice` (
  ...
  `invoice_disc_amount2` decimal(16,2) DEFAULT NULL,
  `invoice_disc_percent2` float DEFAULT NULL,
  ...
  `invoice_shipping_cost` decimal(16,2) DEFAULT '0.00',
  `created_on` datetime DEFAULT NULL,
  `updated_on` datetime DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_sales_invoice_item` (
  ...
  `invoice_item_disc_amount2` decimal(16,2) DEFAULT NULL,
  `invoice_item_disc_percent2` float DEFAULT NULL,
...
('ADMIN','1','ADMIN','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('comissiontype.default.create','2','Tambah Tipe Komisi Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('comissiontype.default.delete','2','Hapus Tipe Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('comissiontype.default.index','2','Lihat Daftar Tipe Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('comissiontype.default.update','2','Edit Tipe Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('customer.default.create','2','Tambah Customer Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('customer.default.delete','2','Hapus Customer','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('customer.default.index','2','Lihat Daftar Customer','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('customer.default.update','2','Edit Customer','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('customer.default.view','2','Lihat Detil Customer','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('employee.default.create','2','Tambah Pegawai Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('employee.default.delete','2','Hapus Pegawai','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('employee.default.index','2','Lihat Daftar Pegawai','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('employee.default.update','2','Edit Pegawai','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('product.default.create','2','Tambah Satuan Barang','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('product.default.delete','2','Hapus Barang','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('product.default.index','2','Lihat Daftar Barang','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('product.default.update','2','Edit Barang','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('product.default.view','2','Lihat Detil Barang','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchaseorder.create','2','Tambah PO Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchaseorder.delete','2','Hapus PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchaseorder.index','2','Lihat Daftar PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchaseorder.update','2','Edit PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchaseorder.view','2','Lihat Detil PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchasepayment.create','2','Tambah Pembayaran PO Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchasepayment.delete','2','Hapus Pembayaran PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchasepayment.index','2','Lihat Daftar Pembayaran PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchasepayment.update','2','Edit Pembayaran PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('purchase.purchasepayment.view','2','Lihat Detil Pembayaran PO','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.comissionpay.create','2','Tambah Pencairan Komisi Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.comissionpay.delete','2','Hapus Pencairan Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.comissionpay.index','2','Lihat Daftar Pencairan Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.comissionpay.update','2','Edit Pencairan Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.comissionpay.view','2','Lihat Detil Pencairan Komisi','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.indent.create','2','Tambah Indent Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.indent.delete','2','Hapus Indent','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.indent.index','2','Lihat Daftar Indent','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.indent.update','2','Edit Indent','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoice.create','2','Tambah Nota Khusus Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoice.delete','2','Hapus Nota Khusus','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoice.index','2','Lihat Daftar Nota Khusus','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoice.update','2','Edit Nota Khusus','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoice.view','2','Lihat Detil Nota Khusus','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoicespecial.create','2','Tambah Nota Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoicespecial.delete','2','Hapus Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoicespecial.index','2','Lihat Daftar Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoicespecial.update','2','Edit Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salesinvoicespecial.view','2','Lihat Detil Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salespayment.create','2',' 
Tambah Pembayaran Nota Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salespayment.delete','2','Hapus Pembayaran Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salespayment.index','2','Lihat Daftar Pembayaran Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salespayment.update','2','Edit Pembayaran Nota','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('sales.salespayment.view','2','Lihat Detil Pembayaran Nota Baru','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.backup.create','2','Buat Backup','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.backup.delete','2','Hapus Backup
','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.backup.download','2','Download Backup','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.backup.index','2','Lihat Daftar Backup','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.default.index','2','Lihat Daftar Setting','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.profile.myprofile','2','Melihat Profile','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.roles.create','2','Buat Peran','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.roles.delete','2','Hapus Peran','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.roles.index','2','Lihat Daftar Peran','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.roles.update','2','Update Peran','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.user.create','2','Buat User','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.user.delete','2','Hapus User','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.user.index','2','Lihat Daftar User','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
('setting.user.update','2','Update User','','','','');
INSERT INTO `auth_item` (`name`,`type`,`description`,`rule_name`,`data`,`created_at`,`updated_at`) VALUES
...
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('42','S00034','Juta Aroma','','Muria RT 01 RW 01 Lodoyo, Kec. Sutojayan, Kab. Blitar (Timur Alun - alun pas)','','Jawa Timur','Blitar','bigreseller','1','30','0.00','','','','','','','','0','active','Bpk. Titis Satria','','085880654333','','','2019-10-14 09:14:58','','1','','0');
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('43','S00035','Illons Parfum','','Raya banyu urip no. 183','','Jawa Timur','Surabaya','smallreseller','0','','','','','','','','','','0','active','Bpk. Usman','','081333008863','','','2019-10-14 09:18:38','','1','','0');
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('44','S00036','PT. Pink Services Indonesia','','Kompleks kedoya centre C 8-9
Jalan raya perjuangan no. 1 Kebun Jeruk','','Jawa Barat','Jakarta','industry','1','30','0.00','','','','','','','','1','active','','','021-5333405','','','2019-10-23 11:07:52','','1','','0');
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('45','S00037','Illons Parfum','','Raya banyu urip no. 183','','Jawa Timur','Surabaya','smallreseller','0','','','','','','','','','','0','active','Bpk. Usman','','081333008863','','','2019-10-23 14:07:44','2019-10-23 14:09:33','1','1','1');
...
-- -------------------------------------------
INSERT INTO `tbl_packaging` (`id`,`packaging_name`,`packaging_value`,`packaging_packing`,`is_deleted`) VALUES
('2','0.5 Kg Alu','0.5','Alu','0');
INSERT INTO `tbl_packaging` (`id`,`packaging_name`,`packaging_value`,`packaging_packing`,`is_deleted`) VALUES
('3','1 Kg Alu','1','Alu','0');
INSERT INTO `tbl_packaging` (`id`,`packaging_name`,`packaging_value`,`packaging_packing`,`is_deleted`) VALUES
('4','5 Kg Jirigen','5','Jirigen','0');
INSERT INTO `tbl_packaging` (`id`,`packaging_name`,`packaging_value`,`packaging_packing`,`is_deleted`) VALUES
('5','25 Kg Drum','25','Drum','0');
INSERT INTO `tbl_packaging` (`id`,`packaging_name`,`packaging_value`,`packaging_packing`,`is_deleted`) VALUES
('1','0.25 kg Alu','0.25','Alu','0');
...
-- -------------------------------------------
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_disc_amount2`,`invoice_disc_percent2`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`invoice_shipping_cost`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('1','41','1','','2019-09-05','9J001','77227875.00','7722787.50','10','','','0.00','','69505087.50','44505087.50','new','partial','14250.00','','','Raja Wangi - Bpk. Agil','Sunu No. 24A','','Sulawesi Selatan','Sulawesi Selatan','','','0.00','2019-10-14 10:08:59','2019-10-24 14:28:56','1','1','0');
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_disc_amount2`,`invoice_disc_percent2`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`invoice_shipping_cost`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('2','43','2','','2019-09-03','9J002','607750.00','0.00','0','','','0.00','0','607750.00','0.00','close','paid','14300.00','','','Illons Parfum - Bpk. Usman','Raya banyu urip no. 183','','Jawa Timur','Jawa Timur','','','0.00','2019-10-23 14:09:17','2019-10-24 14:30:44','1','1','0');
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_disc_amount2`,`invoice_disc_percent2`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`invoice_shipping_cost`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('3','12','1','','2019-11-20','9K001','15265000.00','1526500.00','10','763250.00','5','1297525.00','10','14272775.00','14272775.00','new','new','14200.00','','','El-Azzam Parfum / Blossom Parfum - Bpk. Muhlis Harahap','Halat No.41 Medan','','Medan','Sumatera Utara','','','0.00','2019-11-20 10:04:26','2019-11-25 11:04:18','1','1','0');
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_disc_amount2`,`invoice_disc_percent2`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`invoice_shipping_cost`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('4','9','1','','2019-11-26','9K002','360.00','0.00','','0.00','0','0.00','0','360.00','360.00','new','new','1.00','','','Aneka Wangi Surabaya - Bpk. Usman','Panggung No. 159   ','','Surabaya','Jawa Timur','','','0.00','2019-11-26 09:44:56','2019-11-26 09:48:07','1','1','0');
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_disc_amount2`,`invoice_disc_percent2`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`invoice_shipping_cost`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('6','17','1','','2019-11-26','9K003','300330000.00','45049500.00','15','0.00','0','0.00','0','255280500.00','255280500.00','new','new','14200.00','','','Tania Parfum - Bpk. Apep','Raya Cihaleut Pakuan (Depan Univ. Pakuan), Tegalega','','Bogor','Jawa Barat','','','0.00','2019-11-26 09:50:56','2019-11-26 10:09:28','1','1','0');
...
-- -------------------------------------------
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('7','1','1015','2','50','2.00','2.35294','5.10','6','85.00','','55503750.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('8','1','1114','2','25','2.00','2.98507','4.02','6','67.00','','21724125.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('9','2','1031','1','0.5','0.00','0','0.00','0','85.00','','607750.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('11','3','1147','4','25','2.00','4.44444','','','45.00','','15265000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('16','4','985','2','2','2.00','4.25532','','','47.00','','90.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('17','4','936','2','2','2.00','4.25532','','','47.00','','90.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('18','4','947','2','2','2.00','4.25532','','','47.00','','90.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('19','4','933','2','2','2.00','4.25532','','','47.00','','90.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('33','6','985','2','50','2.00','4.25532','','','47.00','','31950000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('34','6','947','2','25','2.00','4.25532','','','47.00','','15975000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('35','6','936','2','100','2.00','4.25532','','','47.00','','63900000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('36','6','932','2','50','2.00','4.25532','','','47.00','','31950000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('37','6','933','2','25','2.00','4.25532','','','47.00','','15975000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('38','6','987','2','30','2.00','4.25532','','','47.00','','19170000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('39','6','972','2','40','2.00','4.25532','','','47.00','','25560000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('40','6','975','2','15','2.00','4.25532','','','47.00','','9585000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('41','6','991','2','60','2.00','4.25532','','','47.00','','38340000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('42','6','928','2','45','2.00','4.25532','','','47.00','','28755000.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_disc_amount2`,`invoice_item_disc_percent2`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('43','6','939','2','30','2.00','4.25532','','','47.00','','19170000.00');



-- -------------------------------------------
-- TABLE DATA tbl_sales_payment
-- -------------------------------------------
INSERT INTO `tbl_sales_payment` (`id`,`payment_code`,`payment_date`,`invoice_id`,`customer_id`,`payment_exchange_rate`,`payment_total_amount`,`payment_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('1','SP2019100001','2019-10-24','1','41','14250.00','25000000.00','','2019-10-24 14:28:56','','1','','0');
INSERT INTO `tbl_sales_payment` (`id`,`payment_code`,`payment_date`,`invoice_id`,`customer_id`,`payment_exchange_rate`,`payment_total_amount`,`payment_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('2','SP2019100002','2019-10-24','2','43','14300.00','607750.00','','2019-10-24 14:30:44','','1','','0');



-- -------------------------------------------
-- TABLE DATA tbl_sales_payment_detail
-- -------------------------------------------
INSERT INTO `tbl_sales_payment_detail` (`id`,`payment_id`,`payment_detail_amount`,`payment_detail_method`,`bank_id`,`payment_detail_creditcard_number`,`payment_detail_debitcard_number`,`payment_detail_bank_acc_number`,`payment_detail_bank_acc_name`) VALUES
('1','1','25000000.00','debitbca','','','','','');
INSERT INTO `tbl_sales_payment_detail` (`id`,`payment_id`,`payment_detail_amount`,`payment_detail_method`,`bank_id`,`payment_detail_creditcard_number`,`payment_detail_debitcard_number`,`payment_detail_bank_acc_number`,`payment_detail_bank_acc_name`) VALUES
('2','2','607750.00','cash','','','','','');
