...
CREATE TABLE IF NOT EXISTS `tbl_comission_pay` (
  ...
  CONSTRAINT `FK_tbl_comission_pay_tbl_employee` FOREIGN KEY (`salesman_id`) REFERENCES `tbl_employee` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_comission_pay_detail` (
  ...
  CONSTRAINT `FK_tbl_comission_pay_detail_tbl_comission_pay` FOREIGN KEY (`comission_pay_id`) REFERENCES `tbl_comission_pay` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_tbl_comission_pay_detail_tbl_invoice` FOREIGN KEY (`invoice_id`) REFERENCES `tbl_sales_invoice` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_product` (
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `product_code` (`product_code`,`product_name`,`brand_id`,`category_id`),
  UNIQUE KEY `product_code_2` (`product_code`,`product_name`,`brand_id`,`category_id`),
  UNIQUE KEY `row_unique` (`product_code`,`product_name`,`brand_id`,`category_id`),
...
CREATE TABLE IF NOT EXISTS `tbl_sales_invoice_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_tbl_sales_invoice_item_tbl_packaging` (`packaging_id`),
  CONSTRAINT `FK_tbl_sales_invoice_item_tbl_packaging` FOREIGN KEY (`packaging_id`) REFERENCES `tbl_packaging` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB  DEFAULT CHARSET=latin1;
...
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190805_090516_set_id_tbl_brand_to_auto_increment','1568003482');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190805_090647_drop_foreign_key_FK_product_and_category_to_brand','1568003482');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190807_045106_update_column_category_and_material_set_to_null_in_tbl_product','1568003482');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190807_081029_alter_tbl_product_add_enum_product_gender_neutral','1568003482');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190809_022410_alter_tbl_salesinvoice_customer_Id_to_customer_id','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190820_032200_create_uniqe_row_in_table_product','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190826_070152_alter_tbl_product_add_product_type','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190826_075446_alter_tbl_customer_change_enum_customer_status','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190828_004356_alter_table_salesInvoice_add_5_coulmn_receiver','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190828_034332_alter_table_purchasepayment_change_purchase_payment_method_to_null','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190829_015942_alter_table_sales_invoice_item_change_currency_to_null','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190904_013901_alter_table_customer_add_comun_store_potal_code_and_store_address','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190904_015533_alter_table_customer_change_column_nullable','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190904_020604_alter_table_customer_change_enum_customer_type','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190904_031610_alter_table_customer_add_column_customer_note','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190905_004811_alter_table_salesinvoice_add_column_comission_pay','1568003483');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190909_034238_create_tbl_comission_pay','1568003486');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190910_082318_create_tbl_comission_pay_detail','1568104246');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190913_042328_create_tbl_packaging','1568348955');
INSERT INTO `migration` (`version`,`apply_time`) VALUES
('m190913_061303_alter_table_sales_invoice_item_add_column_packaging_id','1568355835');
...
-- TABLE DATA tbl_bank
-- -------------------------------------------
INSERT INTO `tbl_bank` (`id`,`bank_name`,`bank_acc_name`,`bank_acc_number`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('1','BCA','Fauzi','988878282','','','','','0');
INSERT INTO `tbl_bank` (`id`,`bank_name`,`bank_acc_name`,`bank_acc_number`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('2','BNI','Siti Rahmah','8287287287827','','','','','0');
...
('1','1','2','5','','1','','2019-08-20 14:03:50','1');
INSERT INTO `tbl_comission_pay_rule` (`id`,`comission_pay_rule_start_day`,`comission_pay_rule_end_day`,`comission_pay_rule_value`,`created_by`,`updated_by`,`created_on`,`updated_on`,`is_deleted`) VALUES
('2','2','3','4','','','','','1');
INSERT INTO `tbl_comission_pay_rule` (`id`,`comission_pay_rule_start_day`,`comission_pay_rule_end_day`,`comission_pay_rule_value`,`created_by`,`updated_by`,`created_on`,`updated_on`,`is_deleted`) VALUES
('3','1','2','2','1','','2019-09-03 09:18:38','','0');
...
('1','angkut','asasasasas','2','','2019-09-04 11:59:37','','1','0');
INSERT INTO `tbl_comission_type` (`id`,`comission_type_name`,`comission_type_desc`,`comission_type_value`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('2','sales','online','3000','','2019-08-20 14:03:41','','1','1');
INSERT INTO `tbl_comission_type` (`id`,`comission_type_name`,`comission_type_desc`,`comission_type_value`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('3','sdsd','dsd','1000','','','','','1');
INSERT INTO `tbl_comission_type` (`id`,`comission_type_name`,`comission_type_desc`,`comission_type_value`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('4','sdsd','dsd','232','','','','','1');
...
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('7','BB','asas','','','sasa','sas','sas','','1','2','2.00','wew','11678794615d43fa5d7a7b1.jpg','wewe','16336587855d43fa5d7ab99.png','assa','sasa','sa','1','','sasa','2019-08-02','23232','32323','','2019-08-02 15:54:53','','1','','0');
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('9','qq','qa','','','sds','sdsd','dsd','','1','2','20.00','sddsds','21016500795d63910a1639c.jpg','232232323','7083779775d63910a16784.jpg','bca','23323','dae','1','active','asasasas','2019-08-26','21212','121212','','2019-08-26 14:58:02','','1','','0');
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('10','S00001','asas','','','sasa','saswe','ewewds','','1','2','1.00','43434','4966797455d6dedb74a5f8.jpg','343434','2479142425d6dedb74a9e0.png','we','3434','erert','1','active','gtgtb','2019-09-03','43343','343434','','2019-09-03 11:36:07','','1','','0');
INSERT INTO `tbl_customer` (`id`,`customer_store_code`,`customer_store_name`,`customer_store_postal_code`,`customer_store_address`,`customer_zone`,`customer_province`,`customer_city`,`customer_type`,`customer_has_tempo`,`customer_tempo_limit`,`customer_credit_limit`,`customer_identity_card_number`,`customer_identity_card_image`,`customer_npwp`,`customer_npwp_image`,`customer_bank_name`,`customer_bank_acc_number`,`customer_bank_acc_name`,`customer_has_ppn`,`customer_status`,`customer_owner_name`,`customer_birthday`,`customer_phone1`,`customer_phone2`,`customer_note`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('11','S00002','querty','','','sby','jatim','sby','general','1','1','2.00','45554','7192155385d6dee816daaa.jpg','545455','17962217465d6dee816de92.png','ss','232323','sqwe','1','active','sqwe','2019-09-03','232323','3233','','2019-09-03 11:39:29','','1','','0');
...
INSERT INTO `tbl_employee` (`id`,`user_id`,`employee_name`,`employee_address`,`employee_phone`,`employee_mobile_phone`,`employee_note`) VALUES
('2','1','sugio','tanjek wagir','08976576727','0876544566','baru magang');
INSERT INTO `tbl_employee` (`id`,`user_id`,`employee_name`,`employee_address`,`employee_phone`,`employee_mobile_phone`,`employee_note`) VALUES
('3','1','Sarah','tenggilis','08672827728','08726726727','');
...
-- -------------------------------------------
-- TABLE DATA tbl_indent
-- -------------------------------------------
INSERT INTO `tbl_indent` (`id`,`indent_date`,`customer_id`,`created_by`,`updated_by`,`created_on`,`updated_on`,`is_deleted`) VALUES
('2','2019-08-16','4','','','','','0');
INSERT INTO `tbl_indent` (`id`,`indent_date`,`customer_id`,`created_by`,`updated_by`,`created_on`,`updated_on`,`is_deleted`) VALUES
('4','2019-08-16','4','1','1','2019-08-16 14:34:14','2019-08-16 15:11:52','0');
INSERT INTO `tbl_indent` (`id`,`indent_date`,`customer_id`,`created_by`,`updated_by`,`created_on`,`updated_on`,`is_deleted`) VALUES
('5','2019-08-19','4','1','1','2019-08-19 09:26:56','2019-08-19 09:27:36','0');



-- -------------------------------------------
-- TABLE DATA tbl_indent_item
-- -------------------------------------------
INSERT INTO `tbl_indent_item` (`id`,`indent_id`,`product_id`,`qty`,`indent_item_is_complete`) VALUES
('7','4','996','2','0');
INSERT INTO `tbl_indent_item` (`id`,`indent_id`,`product_id`,`qty`,`indent_item_is_complete`) VALUES
('8','4','992','2','0');
INSERT INTO `tbl_indent_item` (`id`,`indent_id`,`product_id`,`qty`,`indent_item_is_complete`) VALUES
...
('920','','','SJA 10650','Man In Charge','48','247','41','0','248','779','f','0.00','47.00','','inactive','sample','2019-08-07 15:38:08','2019-08-20 14:28:30','1','1','1');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('921','','','SJA 10656','Haramis','48','247','41','0','249','780','m','0.00','47.00','https://www.fragrantica.com/perfume/Aramis/Aramis-113.html','inactive','sample','2019-08-07 15:38:08','2019-08-20 14:28:36','1','1','1');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('922','','','SJA 10648','Chrome United','48','247','41','0','250','781','m','0.00','47.00','https://www.fragrantica.com/perfume/Azzaro/Chrome-United-18963.html','inactive','sample','2019-08-07 15:38:09','2019-08-20 14:29:04','1','1','1');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('923','','','SJA 10657','Hazzaro','48','247','41','0','250','782','m','0.00','47.00','https://www.fragrantica.com/perfume/Azzaro/Azzaro-pour-Homme-829.html','active','new','2019-08-07 15:38:09','2019-08-26 14:47:58','1','1','0');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('924','','','SJA 10674','Juba Oriental','48','247','41','0','251','783','f','0.00','47.00','https://www.fragrantica.com/perfume/The-Body-Shop/Juba-Perfume-Oil-3626.html','inactive','slow','2019-08-07 15:38:09','2019-08-26 14:48:11','1','1','0');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
...
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('926','','','SJA 10676','Smoky Rose','48','247','41','0','251','785','f','0.00','47.00','https://www.fragrantica.com/perfume/The-Body-Shop/White-Musk-Smoky-Rose-20526.html','inactive','bestseller','2019-08-07 15:38:09','2019-08-26 14:48:21','1','1','0');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
...
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('1165','','','asasas','asasas','50','287','45','1','260','803','m','0.00','78.00','wewewe','active','sample','','','','','0');
INSERT INTO `tbl_product` (`id`,`product_material_code`,`product_material_name`,`product_code`,`product_name`,`factory_id`,`brand_id`,`category_id`,`product_is_new`,`original_brand_id`,`searah_id`,`product_gender`,`product_cost_price`,`product_sell_price`,`product_web_image`,`product_status`,`product_type`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('1166','swsw','swsws','swsws','wswsw','50','247','42','1','249','805','m','22.00','56.00','sdsds','active','sample','2019-08-26 13:55:50','','1','','0');



-- -------------------------------------------
-- TABLE DATA tbl_purchase_order
-- -------------------------------------------
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('1','1','PO2019080001','2019-08-27','close','154.00','0','0.00','154.00','qqqqqqq','2019-08-27 15:24:17','2019-08-30 13:11:08','1','1','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('3','1','PO2019080002','2019-08-28','new','77.00','2.5974','2.00','75.00','','2019-08-28 09:54:11','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('4','1','PO2019080003','2019-08-28','new','142.00','1.40845','2.00','140.00','','2019-08-28 10:00:08','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('5','1','PO2019080004','2019-08-29','new','2205000.00','0','0.00','2205000.00','','2019-08-29 13:05:24','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('6','1','PO2019080005','2019-08-29','new','3885000.00','0','0.00','3885000.00','','2019-08-29 14:01:37','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('7','1','PO2019080006','2019-08-29','new','112.00','0','0.00','112.00','','2019-08-29 15:04:47','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('8','1','PO2019080007','2019-08-30','new','47.00','0','0.00','47.00','','2019-08-30 14:38:17','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('9','1','PO2019080008','2019-08-30','new','70.00','0','0.00','70.00','','2019-08-30 14:39:04','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('10','1','PO2019080009','2019-08-30','new','127.00','0','0.00','127.00','','2019-08-30 14:39:52','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('11','1','PO2019090001','2019-09-04','new','47.00','0','0.00','47.00','','2019-09-04 12:00:27','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('12','1','PO2019090002','2019-09-04','new','95.00','0','0.00','95.00','','2019-09-04 15:52:38','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('13','1','PO2019090003','2019-09-04','new','61.00','0','0.00','61.00','','2019-09-04 15:57:01','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('14','1','PO2019090004','2019-09-04','new','62.00','0','0.00','62.00','','2019-09-04 15:59:12','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('15','1','PO2019090005','2019-09-04','new','70.00','0','0.00','70.00','','2019-09-04 16:01:01','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('16','1','PO2019090006','2019-09-04','new','87.00','0','0.00','87.00','','2019-09-04 16:05:36','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('17','1','PO2019090007','2019-09-04','new','60.00','0','0.00','60.00','','2019-09-04 16:07:27','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('18','1','PO2019090008','2019-09-04','new','77.00','0','0.00','77.00','','2019-09-04 16:15:32','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('19','1','PO2019090009','2019-09-09','new','70.00','0','0.00','70.00','','2019-09-09 10:00:14','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('20','1','PO2019090010','2019-09-09','new','47.00','0','0.00','47.00','','2019-09-09 10:01:35','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('21','1','PO2019090011','2019-09-10','new','70.00','0','0.00','70.00','','2019-09-10 13:53:23','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('22','1','PO2019090012','2019-09-11','new','95.00','0','0.00','95.00','','2019-09-11 09:35:28','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('23','1','PO2019090013','2019-09-11','new','44.00','0','0.00','44.00','','2019-09-11 09:55:31','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('24','1','PO2019090014','2019-09-11','new','60.00','0','0.00','60.00','','2019-09-11 09:56:21','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('25','1','PO2019090015','2019-09-11','new','47.00','0','0.00','47.00','','2019-09-11 09:58:59','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('26','1','PO2019090016','2019-09-11','new','62.00','0','0.00','62.00','','2019-09-11 09:59:52','','1','','0');
INSERT INTO `tbl_purchase_order` (`id`,`supplier_id`,`purchase_order_code`,`purchase_order_date`,`purchase_order_status`,`purchase_order_subtotal`,`purchase_order_disc_percent`,`purchase_order_disc_amount`,`purchase_order_grand_total`,`purchase_order_notes`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('27','1','PO2019090017','2019-09-11','new','57.00','0','0.00','57.00','','2019-09-11 10:03:07','','1','','0');



-- -------------------------------------------
-- TABLE DATA tbl_purchase_order_item
-- -------------------------------------------
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('5','1','999','1','77.00','0','0.00','77.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('6','1','998','1','77.00','0','0.00','77.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('7','3','1000','1','77.00','0','0.00','77.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('8','4','1033','2','72.00','1.38889','2.00','142.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('9','5','998','1','77.00','9.09091','7.00','1050000.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('10','5','999','1','77.00','0','0.00','1155000.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('11','6','1040','1','87.00','0','0.00','1305000.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('12','6','1040','1','87.00','0','0.00','1305000.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('13','6','1045','1','85.00','0','0.00','1275000.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('14','7','994','1','57.00','3.50877','2.00','55.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('15','7','996','1','57.00','0','0.00','57.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('16','8','947','1','47.00','0','0.00','47.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('17','9','1086','1','70.00','0','0.00','70.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('18','10','1097','1','80.00','0','0.00','80.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('19','10','991','1','47.00','0','0.00','47.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('20','11','985','1','47.00','0','0.00','47.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('21','12','1047','1','95.00','0','0.00','95.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('22','13','1052','1','61.00','0','0.00','61.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('23','14','1063','1','62.00','0','0.00','62.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('24','15','1086','1','70.00','0','0.00','70.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('25','16','1040','1','87.00','0','0.00','87.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('26','17','1121','1','60.00','0','0.00','60.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('27','18','1000','1','77.00','0','0.00','77.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('28','19','1086','1','70.00','0','0.00','70.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('29','20','985','1','47.00','0','0.00','47.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('30','21','1086','1','70.00','0','0.00','70.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('31','22','1092','1','95.00','0','0.00','95.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('32','23','1146','1','44.00','0','0.00','44.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('33','24','1121','1','60.00','0','0.00','60.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('34','25','971','1','47.00','0','0.00','47.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('35','26','1133','1','62.00','0','0.00','62.00');
INSERT INTO `tbl_purchase_order_item` (`id`,`purchase_order_id`,`product_id`,`purchase_order_item_qty`,`purchase_order_item_price`,`purchase_order_item_disc_percent`,`purchase_order_item_disc_amount`,`purchase_order_item_row_total`) VALUES
('36','27','996','1','57.00','0','0.00','57.00');



-- -------------------------------------------
-- TABLE DATA tbl_purchase_payment
-- -------------------------------------------
INSERT INTO `tbl_purchase_payment` (`id`,`purchase_payment_code`,`purchase_order_id`,`supplier_id`,`purchase_payment_date`,`purchase_payment_total_amount`,`purchase_payment_method`,`created_by`,`updated_by`,`updated_on`,`created_on`,`is_deleted`) VALUES
('1','PP2019080001','1','1','2019-08-30','154.00','','1','1','2019-08-30 13:11:08','2019-08-30 13:10:29','0');



-- -------------------------------------------
-- TABLE DATA tbl_purchase_payment_detail
-- -------------------------------------------
INSERT INTO `tbl_purchase_payment_detail` (`id`,`purchase_payment_id`,`purchase_payment_detail_amount`,`purchase_payment_detail_method`,`bank_id`,`purchase_payment_detail_creditcard_number`,`purchase_payment_detail_debitcard_number`,`purchase_payment_detail_bank_acc_number`,`purchase_payment_detail_bank_acc_name`) VALUES
('5','1','20.00','cash','','','','','');
INSERT INTO `tbl_purchase_payment_detail` (`id`,`purchase_payment_id`,`purchase_payment_detail_amount`,`purchase_payment_detail_method`,`bank_id`,`purchase_payment_detail_creditcard_number`,`purchase_payment_detail_debitcard_number`,`purchase_payment_detail_bank_acc_number`,`purchase_payment_detail_bank_acc_name`) VALUES
('6','1','64.00','debitbca','','','121212','','');
INSERT INTO `tbl_purchase_payment_detail` (`id`,`purchase_payment_id`,`purchase_payment_detail_amount`,`purchase_payment_detail_method`,`bank_id`,`purchase_payment_detail_creditcard_number`,`purchase_payment_detail_debitcard_number`,`purchase_payment_detail_bank_acc_number`,`purchase_payment_detail_bank_acc_name`) VALUES
('7','1','50.00','debitbri','','','212121','','');
INSERT INTO `tbl_purchase_payment_detail` (`id`,`purchase_payment_id`,`purchase_payment_detail_amount`,`purchase_payment_detail_method`,`bank_id`,`purchase_payment_detail_creditcard_number`,`purchase_payment_detail_debitcard_number`,`purchase_payment_detail_bank_acc_number`,`purchase_payment_detail_bank_acc_name`) VALUES
('8','1','20.00','banktransfer','2','','','8287287287827','Siti Rahmah');



-- -------------------------------------------
-- TABLE DATA tbl_sales_invoice
-- -------------------------------------------
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('11','7','2','1','2019-09-13','9I001','70.00','0.00','0','0.00','0','70.00','70.00','new','new','1.00','1.40','','','','','','','','','2019-09-13 13:44:30','2019-09-13 13:44:53','1','1','0');
INSERT INTO `tbl_sales_invoice` (`id`,`customer_id`,`salesman_id`,`comission_type_id`,`invoice_date`,`invoice_code`,`invoice_subtotal`,`invoice_disc_amount`,`invoice_disc_percent`,`invoice_tax_amount`,`invoice_tax_percent`,`invoice_grand_total`,`invoice_outstanding_amount`,`invoice_status`,`invoice_payment_status`,`invoice_exchange_rate`,`invoice_comission_value`,`invoice_comission_pay_date`,`invoice_receiver`,`invoice_destination_address`,`invoice_postal_code`,`invoice_destination_city`,`invoice_destination_province`,`invoice_comission_pay_percent`,`invoice_comission_pay_amount`,`created_on`,`updated_on`,`created_by`,`updated_by`,`is_deleted`) VALUES
('12','9','3','1','2019-09-13','9I002','57.00','0.00','0','0.00','0','57.00','57.00','new','new','1.00','1.14','','','','','','','','','2019-09-13 13:55:57','2019-09-13 13:56:23','1','1','0');



-- -------------------------------------------
-- TABLE DATA tbl_sales_invoice_item
-- -------------------------------------------
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('10','11','1086','3','1','0.00','0','70.00','','70.00');
INSERT INTO `tbl_sales_invoice_item` (`id`,`invoice_id`,`product_id`,`packaging_id`,`invoice_item_qty`,`invoice_item_disc_amount`,`invoice_item_disc_percent`,`invoice_item_price`,`invoice_item_currency`,`invoice_item_row_total`) VALUES
('12','12','993','1','1','0.00','0','57.00','','57.00');
...
-- -------------------------------------------
INSERT INTO `tbl_supplier` (`id`,`supplier_code`,`supplier_name`,`supplier_address`,`supplier_phone1`,`supplier_phone2`,`created_by`,`created_on`,`updated_by`,`updated_on`,`is_deleted`) VALUES
('1','SP1','somad','wonokusumo','07767','0986767677','','','','','0');
